...
INSTALLER_SIGN_IDENTITY := D29E16F7E1D33588359CDEC0A3BCE9A7C8211B73
XCODEBUILD_FLAGS ?= -skipPackagePluginValidation
export DISABLE_SWIFTLINT := 1

.PHONY: install_git_hooks check_team_ids

install_git_hooks:
	git config core.hooksPath .githooks

check_team_ids:
	bash Scripts/check_team_ids.sh
...
build_macos_pkg_apple: archive_macos_standalone_apple export_macos_standalone_apple
	...
	pkgbuild --root "build/pkgroot-arm64" \
		...
		--identifier com.akinokaede.sfa.standalone \
